...
\sepsection
    ...
    \resumeSubheading
      ...
      \resumeItem{Deployed load estimation models for tens of candidate sourcing projects for all recruiting teams.}
      \resumeItemListEnd
      \resumeTech{Company summary}{Recruiting firm building tools for candidate selection and hiring analytics.}
      \begin{tcolorbox}[width=.43\linewidth]
          \textbf{Tech:} R, Shiny, Latex, SQL and Metabase.
      \end{tcolorbox}
...
%\newpage
    ...
    \resumeSubheading
     ...
     \resumeItemListStart
     \resumeItem{Performed social network analysis on millions of social media users and posts to detect hubs, and performed supervised and unsupervised learning.}
     \resumeItem{Built and implemented classification models, perform feature engineering, and calibrated existing models.}
     \resumeItemListEnd
     \resumeTech{Company summary}{Social media advertising company helping businesses target customers with AI}
     \begin{tcolorbox}[width=.37\linewidth]
         \textbf{Tech:} Python, R, Bash, Scikit learn.
     \end{tcolorbox}
...
\section{Technical skills}
  ...
  \resumeSubItem{\textbf{Programming languages:} Python, R, Bash, Julia, TS/JS.}
  
  \resumeSubItem{\textbf{Cloud services:} AWS (Lambda, S3, Sagemaker), GCP ( Vertex AI, BigQuery), Azure (Functions, Blob storage, AKS).}
  
  \resumeSubItem{\textbf{Deep learning frameworks:} Keras, Tensorflow, Pytorch, HuggingFace, sbert.}
  
  \resumeSubItem{\textbf{Others:} xgboost, scikit, pandas, falcon, flask, fastapi, Docker, Kubernetes, Jenkins, Terraform}

  \resumeSubItem{\textbf{Currently learning:} Nuxt, Nodejs.}
