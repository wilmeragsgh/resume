...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItem{Develop Agents with tooling access to satisfy Real estate use cases}
      \resumeItemListEnd
      \resumeTech{Technologies}{Azure, Python, PromptLayer, LLMs, OpenAI ChatGPT, Claude, Langchain.}
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeTech{Technologies}{Azure, Python, Django, LLMs, OpenAI, Langchain.}
