...
\pagebreak
\resumeSubItem{\href{https://github.com/DiegoRenner/jaxFlowSim}{On differentiable simulations of haemodynamic systems: A 1D-haemodynamics solver written in Python using JAX. The differentiability of the solver aims to aid in the development of personalised medicine. (Master's Thesis, Mathematics)}}
