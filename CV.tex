...
\begin{minipage}[T]{0.69\textwidth}
		\includegraphics[width=0.5\textwidth, right]{Diego-9.jpg}
\end{minipage}
% ---
...
\resumeTech{Theory}{(C)NN, GMM, PCA, SMOTE}
...
\resumeSubItem{Raman spectroscopy enabled automatic media release through convolutional neural networks. (Work in Progress)}{}
\resumeSubHeadingListEnd
% ---
