...
\resumeSubItem{\href{https://github.com/DiegoRenner/HelmholtzTransmissionProblemBEM}{ML based game simulation in a finance setting: Agents trained to trade or hold a stock taking into account real historical data on cash returns. Policies are learned via reinforcment learning.}}
